...
public static class HResultCatalog
{
    private static readonly IReadOnlyDictionary<uint, HResultExplanation> Known =
        new Dictionary<uint, HResultExplanation>
        {
            ...
            [0x8024C006] = new("0x8024C006", "WU_E_DRV_SYNC_FAILED", "Windows Update driver synchronization failed.", "Review SetupAPI, WUA events, PnP state, and driver catalog source reachability."),
